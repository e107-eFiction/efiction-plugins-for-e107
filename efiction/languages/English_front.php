...
define('_WRONGPASSWORD', "That password doesn't match the one in our database. Please <a href=\"".e_LOGIN."\">try again</a> or retrieve a <a href=\"member.php?action=lostpassword\">new password</a> if you can't remember yours.");
