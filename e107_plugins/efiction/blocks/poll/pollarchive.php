...
if($poll) {
	...
	$listquery = dbquery("SELECT poll_id, poll_question,  poll_start as start,  poll_end  as end FROM ".TABLEPREFIX."fanfiction_poll WHERE poll_end IS NOT NULL OR poll_end != '0000-00-00 00:00:00' ORDER BY poll_id DESC");
