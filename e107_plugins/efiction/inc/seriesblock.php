...
if (!defined('e107_INIT')) { exit; }
	...
	$serie_template = e107::getTemplate('efiction', $key, 'serieblock');
    $sc_serie = e107::getScParser()->getScObject('series_shortcodes', 'efiction', false);
	$sc_serie->setVars($stories);

	$seriesblock = e107::getParser()->parseTemplate($serie_template['item'], true, $sc_serie);
