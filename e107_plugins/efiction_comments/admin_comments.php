...
class comments_admin extends e_admin_dispatcher
{
	...
	protected $menuTitle = LAN_COMMENTMAN . "(eFiction)";
...
class comments_admin_ui extends e_admin_ui
{
		...
		protected $pluginTitle = LAN_COMMENTMAN . "(eFiction)";
		protected $pluginName = 'core';
		protected $eventName = 'efiction_comment';
		protected $table = "fanfiction_comments";
		
		protected $listQry = "SELECT c.*,u.user_name FROM #fanfiction_comments as c LEFT JOIN #user AS u ON c.comment_author_id = u.user_id ";
    	...
    	protected $fields = array(
            ...
            'comment_blocked' 		=> array('title'=> LAN_STATUS,		'type' => 'method',	 	'inline'=>false, /*'writeParms' => array("approved","blocked","pending"), */'data'=> 'int', 'thclass' => 'center', 'class'=>'status center', 'filter' => true, 'batch' => true,	'width' => 'auto'),	 	// Photo
	   		...
	   		'comment_type' 			=> array('title'=> LAN_TYPE, 'type'=>'dropdown', 'writeParms'=>array(),	'width' => '10%',  'filter'=>TRUE),	
